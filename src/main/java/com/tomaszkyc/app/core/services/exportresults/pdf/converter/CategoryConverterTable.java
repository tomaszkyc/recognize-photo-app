...
public class CategoryConverterTable implements TableGenericConverter<Category, PdfPTable> {

    private TranslationService translationService;

    public CategoryConverterTable() {
        this.translationService = ServiceFactory.getTranslationService();
    }

    @Override
    public PdfPTable convert(Category element) {
        ...
        List<UIResult> uiResults = new com.tomaszkyc.app.core.util.converter.CategoryConverter().
